...
pub mod function_enums {
    ...
    #[repr(i32)]
    pub enum Volatility {
        /// Same answer for the same inputs.  e.g. 1+2
        Immutable = 0,
...
pub enum LanguageFeature {
    ...
    FeatureCreateExternalTableWithPartitionColumns = 47,
    /// If set, it disables the NUMERIC signatures for EXP, LN, LOG, LOG10 and
    /// SQRT.
    FeatureNoAdvancedNumericMathSignatures = 48,
    /// INTERVAL data type. (broken link)
    FeatureIntervalType = 49,
...
pub enum ResolvedAstRewrite {
    /// Make sure default value of 0 is not an AST rewrite.
    RewriteInvalidDoNotUse = 0,
...
pub enum FunctionSignatureId {
    ...
    // in ranges:
    //
    // 0002-0999 Non-standard function calls   (NextId: 269)
    // 1000-1099 String functions              (NextId: 1081)
    // 1100-1199 Control flow functions        (NextId: 1104)
    // 1200-1299 Time functions                (Fully used)
    // 1300-1399 Math functions                (Fully used)
    // 1400-1499 Aggregate functions           (NextId: 1489)
    // 1500-1599 Analytic functions            (NextId: 1513)
    // 1600-1699 Misc functions                (NextId: 1688)
    // 1700-1799 Net functions                 (NextId: 1716)
    // 1800-1899 More time functions           (NextId: 1845)
    ...
    FnSoundexString = 1069,
    /// ASCII(string) -> int64
    FnAsciiString = 1072,
    /// ASCII(bytes) -> int64
    FnAsciiBytes = 1073,
    /// translate(string, string, string) -> string
    FnTranslateString = 1074,
    /// soundex(bytes, bytes, bytes) -> bytes
    FnTranslateBytes = 1075,
    /// initcap(string[, string]) -> string
    FnInitcapString = 1076,
    /// unicode(string) -> int64
    FnUnicodeString = 1077,
    /// chr(int64) -> string
    FnChrString = 1078,
    /// regex_instr(string, string[, int64[, int64[, int64]]])
    FnRegexpInstrString = 1079,
    /// regex_instr(bytes, bytes[, int64[, int64[, int64]]])
    FnRegexpInstrBytes = 1080,
    ...
    /// datetime
    FnDatetimeFromDatetime = 1835,
    /// datetime
    FnDatetimeFromString = 1839,
    /// string
    FnStringFromDate = 1840,
    /// string
    FnStringFromTimestamp = 1274,
    /// string
    FnStringFromDatetime = 1841,
    /// string
    FnStringFromTime = 1842,
    ...
    FnRoundNumeric = 1363,
    /// round(bignumeric) -> bignumeric
    FnRoundBignumeric = 1397,
    ...
    FnRoundWithDigitsBignumeric = 1398,
    /// trunc(double) -> double
    FnTruncDouble = 1309,
    /// trunc(float) -> float
    FnTruncFloat = 1310,
    ...
    FnTruncNumeric = 1365,
    /// trunc(bignumeric) -> bignumeric
    FnTruncBignumeric = 1399,
    ...
    FnTruncWithDigitsBignumeric = 2300,
    /// ceil(double) -> double
    FnCeilDouble = 1313,
    /// ceil(float) -> float
    FnCeilFloat = 1314,
    ...
    FnCeilNumeric = 1368,
    /// ceil(bignumeric) -> bignumeric
    FnCeilBignumeric = 1393,
    /// floor(double) -> double
    FnFloorDouble = 1315,
    /// floor(float) -> float
    FnFloorFloat = 1316,
    ...
    FnFloorNumeric = 1369,
    /// floor(bignumeric) -> bignumeric
    FnFloorBignumeric = 1394,
    ...
    FnModNumeric = 1367,
    /// mod(bignumeric, bignumeric) -> bignumeric
    FnModBignumeric = 2301,
    ...
    FnDivNumeric = 1362,
    /// div(bignumeric, bignumeric) -> bignumeric
    FnDivBignumeric = 2302,
    /// is_inf
    FnIsInf = 1317,
    /// is_nan
    FnIsNan = 1318,
    ...
    FnSqrtNumeric = 2308,
    /// sqrt(bignumeric) -> bignumeric
    FnSqrtBignumeric = 2309,
    /// pow
    FnPowDouble = 1324,
    /// pow(numeric, numeric) -> numeric
    FnPowNumeric = 1370,
    /// pow(bignumeric, bignumeric) -> bignumeric
    FnPowBignumeric = 2303,
    /// exp
    FnExpDouble = 1325,
    /// exp(numeric) -> numeric
    FnExpNumeric = 2304,
    /// exp(bignumeric) -> bignumeric
    FnExpBignumeric = 2305,
    /// ln and log
    FnNaturalLogarithmDouble = 1326,
    /// ln(numeric) -> numeric and log(numeric) -> numeric
    FnNaturalLogarithmNumeric = 2306,
    /// ln(bignumeric) -> bignumeric and log(bignumeric) -> bignumeric
    FnNaturalLogarithmBignumeric = 2307,
    /// log10
    FnDecimalLogarithmDouble = 1345,
    /// log10(numeric) -> numeric
    FnDecimalLogarithmNumeric = 2310,
    /// log10(bignumeric) -> bignumeric
    FnDecimalLogarithmBignumeric = 2311,
    /// log
    FnLogarithmDouble = 1327,
    /// log(numeric, numeric) -> numeric
    FnLogarithmNumeric = 2312,
    /// log(bignumeric, bignumeric) -> bignumeric
    FnLogarithmBignumeric = 2313,
    /// cos
    FnCosDouble = 1328,
    /// cosh
    FnCoshDouble = 1329,
    ...
    /// hll_count.init(bignumeric)
    FnHllCountInitBignumeric = 1481,
    ...
    FnCorrNumeric = 1471,
    /// corr
    FnCorrBignumeric = 1488,
    /// covar_pop
    FnCovarPop = 1436,
    /// covar_pop
    FnCovarPopNumeric = 1472,
    /// covar_pop
    FnCovarPopBignumeric = 1486,
    /// covar_samp
    FnCovarSamp = 1437,
    /// covar_samp
    FnCovarSampNumeric = 1473,
    /// covar_samp
    FnCovarSampBignumeric = 1487,
    /// stddev_pop
    FnStddevPop = 1438,
    /// stddev_pop
    FnStddevPopNumeric = 1474,
    /// stddev_pop
    FnStddevPopBignumeric = 1482,
    /// stddev_samp
    FnStddevSamp = 1439,
    /// stddev_samp
    FnStddevSampNumeric = 1475,
    /// stddev_samp
    FnStddevSampBignumeric = 1483,
    /// var_pop
    FnVarPop = 1440,
    /// var_pop
    FnVarPopNumeric = 1476,
    /// var_pop
    FnVarPopBignumeric = 1484,
    /// var_samp
    FnVarSamp = 1441,
    /// var_samp
    FnVarSampNumeric = 1477,
    /// var_samp
    FnVarSampBignumeric = 1485,
    /// countif
    FnCountif = 1443,
    ...
    /// percentile_cont
    FnPercentileContNumeric = 1513,
    /// percentile_cont
    FnPercentileContBignumeric = 1515,
    /// percentile_disc
    FnPercentileDisc = 1512,
    /// percentile_disc
    FnPercentileDiscNumeric = 1514,
    /// percentile_disc
    FnPercentileDiscBignumeric = 1516,
    //
    // Misc functions.
    ...
    /// generate_array(bignumeric)
    FnGenerateArrayBignumeric = 1683,
    ...
    FnJsonExtractJson = 1684,
    /// json_extract_scalar(string, string) -> string
    FnJsonExtractScalar = 1620,
    /// json_extract_scalar(json, string) -> string
    FnJsonExtractScalarJson = 1685,
    ...
    FnJsonQuery = 1623,
    /// json_query(json, string) -> json
    FnJsonQueryJson = 1686,
    /// json_value(string, string) -> string
    FnJsonValue = 1624,
    /// json_value(json, string) -> string
    FnJsonValueJson = 1687,
    ...
    /// enum_value_descriptor_proto(<enum expression>) ->
    FnEnumValueDescriptorProto = 1682,
    ...
    FnStGeogFromTextExt = 2060,
    FnStGeogFromKml = 2051,
    FnStGeogFromGeoJson = 2052,
    FnStGeogFromGeoJsonExt = 2068,
    ...
    FnArrayIsDistinct = 2501,
    /// $proto_map_at_key
    FnProtoMapAtKey = 2502,
    /// $safe_proto_map_at_key
    FnSafeProtoMapAtKey = 2503,
}
...
pub enum ResolvedNodeKind {
    ...
    ResolvedRecursiveRefScan = 147,
    ResolvedRecursiveScan = 148,
    ResolvedWithScan = 51,
    ...
    ResolvedAlterAllRowAccessPoliciesStmt = 145,
    ...
    ResolvedSingleAssignmentStmt = 160,
    ResolvedCreateEntityStmt = 154,
    ResolvedAlterEntityStmt = 155,
    /// User code that switches on this enum must have a default case so
    /// builds won't break if new enums get added.
...
pub mod resolved_recursive_scan_enums {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
    pub enum RecursiveSetOperationType {
        UnionAll = 0,
        UnionDistinct = 1,
    }
}
...
pub mod any_resolved_argument_proto {
    ...
    pub enum Node {
        ...
        ResolvedFunctionArgumentNode(super::ResolvedFunctionArgumentProto),
        ...
        ResolvedExtendedCastElementNode(super::ResolvedExtendedCastElementProto),
        #[prost(message, tag = "153")]
        ResolvedWithPartitionColumnsNode(super::ResolvedWithPartitionColumnsProto),
        #[prost(message, tag = "158")]
        ResolvedExtendedCastNode(super::ResolvedExtendedCastProto),
        #[prost(message, tag = "159")]
        ResolvedInlineLambdaNode(super::ResolvedInlineLambdaProto),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod any_resolved_statement_proto {
    ...
    pub enum Node {
        ...
        ResolvedExportModelStmtNode(super::ResolvedExportModelStmtProto),
        #[prost(message, tag = "160")]
        ResolvedSingleAssignmentStmtNode(super::ResolvedSingleAssignmentStmtProto),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod any_resolved_create_statement_proto {
    ...
    pub enum Node {
        ...
        ResolvedCreateEntityStmtNode(super::ResolvedCreateEntityStmtProto),
        #[prost(message, tag = "157")]
        ResolvedCreateSchemaStmtNode(super::ResolvedCreateSchemaStmtProto),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod any_resolved_alter_object_stmt_proto {
    ...
    pub enum Node {
        ...
        ResolvedAlterAllRowAccessPoliciesStmtNode(
            super::ResolvedAlterAllRowAccessPoliciesStmtProto,
        ),
        #[prost(message, tag = "155")]
        ResolvedAlterEntityStmtNode(super::ResolvedAlterEntityStmtProto),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod any_resolved_alter_action_proto {
    ...
    pub enum Node {
        ...
        ResolvedSetAsActionNode(super::ResolvedSetAsActionProto),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
