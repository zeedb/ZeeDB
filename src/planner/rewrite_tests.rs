...
fn test_rewrite() {
    let mut errors = vec![];
    ok!(
        "examples/rewrite/semi_join.txt",
        r#"
            select 1 
            from person 
    ...
    ok!(
        "examples/rewrite/single_join.txt",
        r#"
    ...
    ok!(
        "examples/rewrite/combine_consecutive_filters.txt",
        r#"
            select 1 
    ...
    ok!(
        "examples/rewrite/combine_consecutive_projects.txt",
        r#"
            select a + 1 as b 
            from (select 1 as a)
        "#,
    ...
    ok!(
        "examples/rewrite/combine_consecutive_projects_star.txt",
        r#"
            select *, a + 1 as b 
            from (select 1 as a)
        "#,
    ...
    ok!(
        "examples/rewrite/pull_filter_through_aggregate.txt",
        r#"
    ...
    ok!(
        "examples/rewrite/remove_single_join.txt",
        r#"
            select (select 1) 
            from customer
        "#,
    ...
    ok!(
        "examples/rewrite/remove_single_join_column.txt",
        r#"
    ...
    ok!(
        "examples/rewrite/remove_with.txt",
        r#"
    ...
    ok!(
        "examples/rewrite/unused_with.txt",
        r#"
    ...
    ok!(
        "examples/rewrite/push_filter_through_project.txt",
        r#"
            select * 
